...
If you are upgrading an existing installation, delete the saved token or rerun the auth flow so the stored credentials include the current Drive, Docs, Slides, and Sheets scopes.
